...
<div class="container">
	<?php echo form_open('forms/user'); ?>
		<table width="100%">
			<tr>
				<td><label form="username">Name</label></td><td> <input type="text" name="username" /></td>
			<td>
			...
			<td><label form="email">Confirm Email</label></td><td> <input type="text" name="confirmemail" /></td>
			<td>
